...
alias gail='wget -R html,htm -r -l inf --no-remove-listing -P /home/tbck/documents/COS/ -nH --cut-dirs=2 -nc -np http://faculty.umf.maine.edu/lange/public.www/cos3722013/'
